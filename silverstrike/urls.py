...
urlpatterns = [
    ...
    path('investments/',
          investment_views.InvestmentView.as_view(), name='investment_overview'),
    ...
    path('investments/config/update',
         investment_views.InvestmentConfigUpdateView.as_view(), name='investment_config_update'),
    path('investments/target',
         investment_views.InvestmentConfigTargetView.as_view(), name='investment_portfolio_target'),
    path('investments/target/update',
         investment_views.InvestmentTargetUpdateView.as_view(), name='investment_target_update'),
    path('investments/security/<str:pk>/update',
    ...
    path('api/investment/stocks-distribution/',
         api.get_stock_distribution_data, name='api_investment_stock_distribution_data'),
    path('api/investment/asset-distribution/',
         api.get_asset_distribution_data, name='api_investment_asset_distribution_data'),
    path('api/investment/stocks-distribution/target/',
         api.get_stock_distribution_target_data, name='api_investment_stock_distribution_target_data'),
    path('api/investment/asset-distribution/target/',
         api.get_asset_distribution_target_data, name='api_investment_asset_distribution_target_data'),
