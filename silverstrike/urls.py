...
urlpatterns = [
    ...
    path('api/investment/asset-distribution/',
         api.get_asset_distribution_data, name='api_investment_stock_distribution_data'),
    path('api/investment/stocks-distribution/target/',
         api.get_asset_distribution_target_data, name='api_investment_stock_distribution_target_data'),
